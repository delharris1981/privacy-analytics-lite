...
## [1.7.10] - 2026-01-18
### Fixed
- **Heatmap Activation**: Fixed issue where administrators were excluded from tracking, preventing the Heatmap Manager list from populating.
- **Security**: Added missing nonce verification to the Heatmap toggle button in the dashboard to prevent CSRF.
